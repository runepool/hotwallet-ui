...
import { MarketMakerTool } from './MarketMakerTool';
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-1 bg-gray-100 p-0.5 rounded-lg">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-sm font-medium transition-all relative ${activeView === 'liquidity'
              ? 'bg-white text-gray-900 shadow-sm'
              : 'text-gray-600 hover:text-gray-900'
              }`}
          >
                        ...
                        <div className="text-xs">
                          ...
                          <span className="ml-1 font-medium text-gray-900">
                            {formatNumber(askOrders.reduce((sum, order) => {
                              ...
                              const price = parseFloat(order.price) / 1e8;
              ...
              <div className="border-b border-gray-200">
                <div className="flex">
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium border-b-2 ${activeTab === 'placeOrder'
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium border-b-2 ${activeTab === 'marketMaker'
                      ? 'border-blue-500 text-blue-600'
                      : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
                  >
                    <div className="flex items-center gap-1.5">
